# This lookup table lovingly borrowed from Bob Rudis (@hrbrmstr), with thanks
# https://stackoverflow.com/questions/40976213/decoding-quoted-printable-string-in-r
# and modified to fix a double-decode bug when a =3D ('=') sequence is followed
# by two characters that can be intepreted as a hex number from \x40 upwards.
# See https://github.com/hrbrmstr/hrbrmisc/pull/6 for details
